...
def WriteFullOTAPackage(input_zip, output_zip):
  ...
  if OPTIONS.ota_zip_check:
    ...
    script.WipeDalvik()
    #script.append('ui_print("wiping dalvik-cache ...");')
    #script.append('mount("ext4", "EMMC", "/dev/block/data", "/data");')
    #script.append('delete_recursive("/data/dalvik-cache");')
    #script.append('unmount("/data");')
    script.Mount("/data")
...
""" % bcb_dev)
    ...
    #self.script.append('mount("ext4", "EMMC", "/dev/block/data", "/data");')
